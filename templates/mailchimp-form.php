...
<form class="epm-sign-up-form" name="epm-sign-up-form" action="#" method="post">
	...
	<div class="epm-form-field">
		...
		<input type="text" placeholder="<?php _e('First Name','easy-peasy-mailchimp');?>" name="epm-first-name" tabindex="7" class="name first-name"/>
	</div>

	<div class="epm-form-field">
		<label for="epm-last-name"><?php _e('Last Name','easy-peasy-mailchimp');?></label>
		<input type="text" placeholder="<?php _e('Last Name','easy-peasy-mailchimp');?>" name="epm-last-name" tabindex="7" class="name last-name"/>
	</div>
	...
	<div class="epm-form-field">
		...
		<input type="email" placeholder="<?php _e('Email Address','easy-peasy-mailchimp');?>" name="epm-email" tabindex="8" class="email" value="<?php echo $epm_default_email_value; ?>"/>
	</div>

	<input type="hidden" name="epm_submit" value="true" />
	<input type="hidden" name="epm_list_id" value="<?php echo $list;?>" />
